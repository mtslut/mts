...
Vue.component('login-box', {
    ...
    created(){
        ...
        if(b2isWeixin() && b2_global.wx_mp_in_login == 1){
            if(!userData.user_link && document.querySelector('#open-page') === null){
...
Vue.component('pagenav-new',{
    ...
    methods:{
        ...
        autoLoadMore(){
			...
			if(scrollTop + window.innerHeight >= document.body.clientHeight - 850) {
...
var postPoBox = new Vue({
    ...
    methods:{
        ...
        go(val,type){
           ...
           console.log(userTools.role[type])
           if(type != 'request'){
...
var b2HotCircle = new Vue({
    ...
    methods:{
        ...
        getCirclesList(type){
            let userData = userTools.userData
            if(!userData.user_link && type !== 'hot'){
                login.show = true
                login.type = 1
                return
            }
